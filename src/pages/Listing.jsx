    ...
    <main>
      ...
      >
        <div className="w-full h-[200px] lg-[400px]">
          ...
          <div className="flex justify-start item-center space-x-4 w-[75%] h-10">
            ...
            {listing.offer && (
              <p className="bg-green-800 w-ful max-w-[200px] rounded-md p-1 text-white text-center font-semibold shadow-md">
          ...
          <FaBed className="text-lg mr-l" />
          {listing.bedrooms > 1 ? `${listing.bedrooms} Beds` : "1 Bed"}
          </li> 

          <li className="flex items-center whitespace-nowrap "> 
          <FaBath className="text-lg mr-l" />
          {listing.bathrooms > 1 ? `${listing.bathrooms} Baths` : "1 Bath"}
          </li> 


          <li className="flex items-center whitespace-nowrap "> 
          <FaParking className="text-lg mr-l" />
          {listing.parking ? "Parking Spot" : "No Parking"}
          </li>


          <li className="flex items-center whitespace-nowrap "> 
          <FaChair className="text-lg mr-l" />
          {listing.furnished ? "Furnished" : "Not Furnished"}
          </li>

          </ul>
        </div>
        <div className="w-full bg-blue-300 h-[200px] lg-[400px] z-10 overflow-x-hidden"></div>
      </div>
    </main>
  );
}
